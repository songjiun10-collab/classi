...
ORBIT_CSS = r"""
  ...
  #space{position:fixed;inset:54px 0 0 0;overflow:hidden;background:radial-gradient(circle at 50% 45%,#0a0a0a,#000 70%)}
  #galaxy{position:absolute;inset:0}
  #sun{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);
    width:88px;height:88px;border-radius:50%;
    background:radial-gradient(circle at 50% 40%,#fff,#cfcfcf 55%,#666);
    box-shadow:0 0 46px 10px rgba(255,255,255,.22);cursor:pointer;z-index:5;
    display:flex;align-items:center;justify-content:center}
  #sun .core{font-family:var(--mono);font-size:8.5px;letter-spacing:.16em;color:#000;
